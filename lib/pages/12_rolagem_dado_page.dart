...
class RolagemDado12Page extends StatefulWidget {
  const RolagemDado12Page({super.key});

  @override
  State<RolagemDado12Page> createState() => _RolagemDado12PageState();
}//end class RolagemDado

class _RolagemDado12PageState extends State<RolagemDado12Page> {
  ...
  void rolarDado() {
    ...
    String resultRandom = (random.nextInt(12) + 1).toString();
    setState(() {
                    ...
                    Padding(
                      ...
                      child: Card(
                        ...
                        child: Stack(
                            ...
                            children: [
                              Image.asset("assets/bg_d12.png", height: 220, width: 220,),
                              Text(
                                resultado,
                                style: TextStyle(
                                    fontSize: 64,
