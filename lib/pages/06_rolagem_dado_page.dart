...
class RolagemDado06Page extends StatefulWidget {
  const RolagemDado06Page({super.key});

  @override
  State<RolagemDado06Page> createState() => _RolagemDado06PageState();
}//end class RolagemDado

class _RolagemDado06PageState extends State<RolagemDado06Page> {
  ...
  void rolarDado() {
    ...
    String resultRandom = (random.nextInt(6) + 1).toString();
    setState(() {
                    ...
                    Padding(
                      ...
                      child: Card(
                        ...
                        child: Stack(
                            ...
                            children: [
                              Image.asset("assets/bg_d6.png", height: 220, width: 220,),
                              Text(
                                resultado,
                                style: TextStyle(
                                    fontSize: 64,
